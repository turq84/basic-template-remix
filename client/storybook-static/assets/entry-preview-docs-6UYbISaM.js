import {
  ...
  c as zn,
  d as Eu,
} from './chunk-XP5HYGXS-CzPF9ozp.js';
import {
  g as Gn,
  y as gu,
  c as Fu,
            ...
            if (!Array.isArray(ne)) {
              ...
              return new k(
                'Invalid ' +
                  ...
                  Q +
                  '` of type ' +
                  ('`' + ie + '` supplied to `' + M + '`, expected an array.')
              );
            }
            ...
            if (ie !== 'object')
              return new k(
                'Invalid ' +
                  ...
                  Q +
                  '` of type ' +
                  ('`' + ie + '` supplied to `' + M + '`, expected an object.')
              );
            for (var le in ne)
              if (o(ne, le)) {
                var Z = S(ne, le, M, X, Q + '.' + le, i);
      ...
      (function t(n) {
        ...
        function d(x) {
          ...
          for (B in x)
            x.hasOwnProperty(B) &&
              ((b = x[B]),
              typeof b == 'object' && b !== null ? (F[B] = d(b)) : (F[B] = b));
          return F;
        }
        function D(x, F) {
          var B, b, I, q;
          ...
          for (
            ...
            if (I.node) {
              if (
                ...
                return;
              if ((B.push(te), b.push(I), this.__state === l || z === l))
                continue;
              if (
                ((q = I.node),
                (U = q.type || I.wrap),
                ...
                if (((G = pe[ee]), (Ae = q[G]), !!Ae)) {
                  if (Array.isArray(Ae)) {
                    for (de = Ae.length; (de -= 1) >= 0; )
                      if (Ae[de] && !T(b, Ae[de])) {
                        if (g(U, pe[ee]))
                          I = new C(Ae[de], [G, de], 'Property', null);
                        else if (m(Ae[de]))
                          I = new C(Ae[de], [G, de], null, null);
                        else continue;
                        B.push(I);
                      }
                  } else if (m(Ae)) {
          ...
          (E.prototype.replace = function (x, F) {
            ...
            for (
              ...
              if (
                ((I = z.node),
                !!I &&
                  (B.push(Ae), b.push(z), !(this.__state === l || U === l)))
              ) {
                      ...
                      for (ee = pe.length; (ee -= 1) >= 0; )
                        if (pe[ee]) {
                          if (g(q, de[G]))
                            ...
                            z = new C(pe[ee], [Ee, ee], null, new y(pe, ee));
                          else continue;
                          B.push(z);
                        }
          ...
          if (!B.length) {
            if (F.length) {
              for (U = 0, q = F.length; U < q; U += 1)
                (I = d(F[U])), (I.extendedRange = [0, x.range[0]]), b.push(I);
              x.leadingComments = b;
            }
            return x;
          }
      ...
      (function () {
        ...
        function d(m) {
          ...
          for (g = 1, T = m.length; g < T; ++g)
            if (((k = m.charCodeAt(g)), !n.isIdentifierPartES5(k))) return !1;
          return !0;
        }
        function D(m, g) {
        ...
        function y(m) {
          ...
          for (R = n.isIdentifierStartES6, g = 0, T = m.length; g < T; ++g) {
            if (((k = m.charCodeAt(g)), 55296 <= k && k <= 56319)) {
              if (
                (++g,
                g >= T || ((v = m.charCodeAt(g)), !(56320 <= v && v <= 57343)))
              )
                return !1;
              k = D(k, v);
            }
    ...
    '../../node_modules/escodegen/node_modules/source-map/lib/source-map-consumer.js'(
          ...
          if (m >= 0) {
            ...
            if (D.column === void 0)
              ...
              for (
                ...
                g && g.originalLine === y && g.originalColumn == k;
      ...
      (l.prototype._parseMappings = function (D, y) {
        for (
          ...
          if (D.charAt(R) === ';') C++, R++, (E = 0);
            ...
            if (((I = D.slice(R, U)), (q = _[I]), q)) R += I.length;
              ...
              for (q = []; R < U; )
                i.decode(D, R, x), (z = x.value), (R = x.rest), q.push(z);
              if (q.length === 2)
        ...
        (l.prototype._findMapping = function (D, y, C, E, m, g) {
          if (D[C] <= 0)
            throw new TypeError(
              'Line must be greater than or equal to 1, got ' + D[C]
            );
          if (D[E] < 0)
            throw new TypeError(
              'Column must be greater than or equal to 0, got ' + D[E]
            );
        ...
        (d.prototype.originalPositionFor = function (D) {
          ...
          return E
            ? E.consumer.originalPositionFor({
                ...
                column:
                  y.generatedColumn -
                  (E.generatedOffset.generatedLine === y.generatedLine
            ...
            if (C.consumer._findSourceIndex(t.getArg(D, 'source')) !== -1) {
              ...
              if (E) {
                var m = {
                  ...
                  column:
                    E.column +
                    (C.generatedOffset.generatedLine === E.line
      ...
      (s.fromStringWithSourceMap = function (l, p, d) {
        ...
        return (
          ...
          p.sources.forEach(function (v) {
            ...
            R != null &&
              (d != null && (v = n.join(d, v)), D.setSourceContent(v, R));
          }),
          D
        );
        function k(v, R) {
        ...
        (s.prototype.walkSourceContents = function (l) {
          ...
          for (
            var D = Object.keys(this.sourceContents), p = 0, d = D.length;
            p < d;
            p++
          )
...
`,
        ...
        function Ne(u, c) {
          ...
          for (a in c)
            c.hasOwnProperty(a) &&
              ((h = c[a]),
              A(h) ? (A(u[a]) ? Ne(u[a], h) : (u[a] = Ne({}, h))) : (u[a] = h));
          return u;
        }
        function rt(u) {
          var c, a, h, A, w;
          ...
          return (
            ...
            (h.length < c.length ||
              (y &&
                u > 1e12 &&
                Math.floor(u) === u &&
                (h = '0x' + u.toString(16)).length < c.length)) &&
              +h === u &&
              (c = h),
            c
          );
        ...
        function ou(u) {
          ...
          if (((a = u.toString()), u.source)) {
            ...
            for (
              h = c[1], a = '', O = !1, V = !1, A = 0, w = u.source.length;
              A < w;
              ++A
            )
        ...
        function du(u, c) {
          ...
          for (
            ...
            for (
              w = a[h], P = 0;
              P < w.length && s.code.isWhiteSpace(w.charCodeAt(P));
        ...
        function Au(u, c) {
          ...
          return (
            ...
            typeof a == 'string'
              ...
              : ((h = Vn(a.content)),
                (A = a.precedence != null ? a.precedence : n.Sequence),
                (h = ye(h, A, c))),
            fe(h, u)
          );
        }
                ...
                c.left.type === t.VariableDeclaration
                  ? ge(function () {
                      h.push(c.left.kind + Be()),
                        h.push(A.generateStatement(c.left.declarations[0], Q));
                    })
                  : h.push(A.generateExpression(c.left, n.Call, S)),
                  (h = Y(h, u)),
                  (h = [
                    Y(h, A.generateExpression(c.right, n.Assignment, S)),
                    ')',
                  ]);
              }),
...
` && (A = ['{']),
                  ...
                  var P, O, V, ae;
                  for (
                    ae = M, c & pe && (ae |= Ae), P = 0, O = u.body.length;
                    P < O;
                    ++P
                  )
                    b &&
...
` && (A = ['{'])),
                        u.body[0].leadingComments ||
                          ut(u.range[0], u.body[0].range[0], A)),
                      P > 0 &&
                      ...
                      A.push(V),
                      se(fe(V).toString()) ||
                        (b && P < O - 1 && u.body[P + 1].leadingComments) ||
                        A.push(m),
                      b &&
                        P === O - 1 &&
                        (u.body[P].trailingComments ||
                          ut(u.body[P].range[1], u.range[1], A));
                }),
                A.push(ve('}')),
                A
              );
              ...
              return (
                ge(function (A) {
                  ...
                  for (w = 0, P = u.body.length; w < P; ++w)
                    a.push(A),
                      a.push(h.generateExpression(u.body[w], n.Sequence, S)),
                      w + 1 < P && a.push(m);
                }),
            ...
            ClassDeclaration: function (u, c) {
              ...
              return (
                (a = ['class']),
                u.id &&
                  (a = Y(a, this.generateExpression(u.id, n.Sequence, S))),
                u.superClass &&
                  ((h = Y(
                    'extends',
                    this.generateExpression(u.superClass, n.Unary, S)
                  )),
                  (a = Y(a, h))),
                a.push(g),
            ...
            DoWhileStatement: function (u, c) {
              ...
              return (
                ...
                Y(a, [
                  'while' + g + '(',
                  this.generateExpression(u.test, n.Sequence, S),
                  ')' + this.semicolon(c),
                ])
              );
            },
              ...
              return (
                ge(function () {
                  ...
                  u.param
                    ? ((a = [
                        'catch' + g + '(',
                        h.generateExpression(u.param, n.Sequence, S),
                        ')',
                      ]),
                      u.guard &&
                        ((A = h.generateExpression(u.guard, n.Sequence, S)),
                        a.splice(2, 0, ' if ', A)))
                    : (a = ['catch']);
                }),
            ...
            ExportDefaultDeclaration: function (u, c) {
              ...
              return (
                ...
                z(u.declaration)
                  ...
                  : (a = Y(
                      a,
                      this.generateExpression(u.declaration, n.Assignment, S) +
                        this.semicolon(c)
                    )),
                a
              );
                        ...
                        : u.specifiers[0].type === t.ExportBatchSpecifier
                          ...
                          : ((a = Y(a, '{')),
                            ge(function (w) {
                              var P, O;
                              for (
                                a.push(m), P = 0, O = u.specifiers.length;
                                P < O;
                                ++P
                              )
                                a.push(w),
            ...
            ExpressionStatement: function (u, c) {
              ...
              function P(O) {
                ...
                for (
                  ae = 6, xe = O.length;
                  ae < xe && s.code.isWhiteSpace(O.charCodeAt(ae));
                  ++ae
                );
              ...
              return u.specifiers.length === 0
                ...
                : ((a = ['import']),
                  ...
                  u.specifiers[h].type === t.ImportDefaultSpecifier &&
                    ((a = Y(a, [
                      this.generateExpression(u.specifiers[h], n.Sequence, S),
                    ])),
                    ++h),
                  u.specifiers[h] &&
                    (h !== 0 && a.push(','),
                      ...
                      : (a.push(g + '{'),
                        u.specifiers.length - h === 1
                          ...
                          : (ge(function (w) {
                              var P, O;
                              for (
                                a.push(m), P = h, O = u.specifiers.length;
                                P < O;
                                ++P
                              )
                                a.push(w),
...
`),
            ...
            ThrowStatement: function (u, c) {
              return [
                Y('throw', this.generateExpression(u.argument, n.Sequence, S)),
                this.semicolon(c),
              ];
            },
              ...
              if (
                ...
                for (h = 0, A = u.handlers.length; h < A; ++h)
                  (a = Y(a, this.generateStatement(u.handlers[h], M))),
                    (u.finalizer || h + 1 !== A) &&
                      (a = this.maybeBlockSuffix(u.handlers[h].body, a));
              else {
                for (
                  w = u.guardedHandlers || [], h = 0, A = w.length;
                  h < A;
                  ++h
                )
                  ...
                  if (Array.isArray(u.handler))
                    for (h = 0, A = u.handler.length; h < A; ++h)
                      (a = Y(a, this.generateStatement(u.handler[h], M))),
                        (u.finalizer || h + 1 !== A) &&
                          (a = this.maybeBlockSuffix(u.handler[h].body, a));
                  else
                    (a = Y(a, this.generateStatement(u.handler, M))),
                      u.finalizer &&
                        (a = this.maybeBlockSuffix(u.handler.body, a));
              }
              return (
                u.finalizer &&
                  (a = Y(a, ['finally', this.maybeBlock(u.finalizer, M)])),
                a
              );
            },
            SwitchStatement: function (u, c) {
              ...
              if (
                (ge(function () {
                  a = [
                    'switch' + g + '(',
                    O.generateExpression(u.discriminant, n.Sequence, S),
                    ')' + g + '{' + m,
                  ];
                }),
                u.cases)
                  ...
                  for (
                    u.test
                      ? (a = [
                          Y(
                            'case',
                            O.generateExpression(u.test, n.Sequence, S)
                          ),
                          ':',
                        ])
                      : (a = ['default:']),
                      ...
                      w &&
                        ...
                        ((h = O.maybeBlock(u.consequent[0], M)),
                        a.push(h),
                        (A = 1)),
            ...
            IfStatement: function (u, c) {
              ...
              return (
                ge(function () {
                  a = [
                    'if' + g + '(',
                    w.generateExpression(u.test, n.Sequence, S),
                    ')',
                  ];
                }),
                (A = c & te),
                ...
                u.alternate
                  ? (a.push(this.maybeBlock(u.consequent, M)),
                    ...
                    u.alternate.type === t.IfStatement
                      ? (a = Y(a, [
                          'else ',
                          this.generateStatement(u.alternate, h),
                        ]))
                  ...
                  (a = ['for' + g + '(']),
                    u.init
                      ? u.init.type === t.VariableDeclaration
                        ...
                        : (a.push(h.generateExpression(u.init, n.Sequence, Re)),
                          a.push(';'))
                      : a.push(';'),
                    u.test &&
                      (a.push(g),
                      a.push(h.generateExpression(u.test, n.Sequence, S))),
                    a.push(';'),
                    u.update &&
                      (a.push(g),
                      a.push(h.generateExpression(u.update, n.Sequence, S))),
                    a.push(')');
                }),
...
`
                ...
                !v && A === w - 1 && (P |= te),
                  b &&
                    (A === 0 &&
                      (u.body[0].leadingComments ||
                        ut(u.range[0], u.body[A].range[0], a)),
                    A > 0 &&
                  ...
                  A + 1 < w &&
                    !se(fe(h).toString()) &&
                    ((b && u.body[A + 1].leadingComments) || a.push(m)),
                  b &&
                    A === w - 1 &&
                    (u.body[A].trailingComments ||
                      ut(u.body[A].range[1], u.range[1], a));
              return a;
            },
            ...
            ReturnStatement: function (u, c) {
              return u.argument
                ? [
                    Y(
                      'return',
                      this.generateExpression(u.argument, n.Sequence, S)
                    ),
                    this.semicolon(c),
                  ]
            ...
            WhileStatement: function (u, c) {
              ...
              return (
                ge(function () {
                  a = [
                    'while' + g + '(',
                    h.generateExpression(u.test, n.Sequence, S),
                    ')',
                  ];
                }),
                a.push(this.maybeBlock(u.body, c & te ? X : M)),
            ...
            WithStatement: function (u, c) {
              ...
              return (
                ge(function () {
                  a = [
                    'with' + g + '(',
                    h.generateExpression(u.object, n.Sequence, S),
                    ')',
                  ];
                }),
                a.push(this.maybeBlock(u.body, c & te ? X : M)),
          ...
          (Fe.Expression = {
            SequenceExpression: function (u, c, a) {
              ...
              for (
                ...
                h.push(
                  this.generateExpression(u.expressions[A], n.Assignment, a)
                ),
                  A + 1 < w && h.push(',' + g);
            ...
            LogicalExpression: function (u, c, a) {
              return (
                u.operator === '??' && (a |= Ee), this.BinaryExpression(u, c, a)
              );
            },
            ...
            CallExpression: function (u, c, a) {
              ...
              for (
                ...
                h.push(
                  this.generateExpression(u.arguments[A], n.Assignment, S)
                ),
                  A + 1 < w && h.push(',' + g);
            ...
            NewExpression: function (u, c, a) {
              ...
              if (
                ...
                for (h.push('('), w = 0, P = A; w < P; ++w)
                  h.push(
                    this.generateExpression(u.arguments[w], n.Assignment, S)
                  ),
                    w + 1 < P && h.push(',' + g);
                h.push(')');
              }
            ...
            MemberExpression: function (u, c, a) {
              ...
              return (
                (h = [
                  this.generateExpression(u.object, n.Call, a & ee ? be : j),
                ]),
                u.computed
                  ? (u.optional && h.push('?.'),
                    h.push('['),
            ...
            MetaProperty: function (u, c, a) {
              ...
              return (
                ...
                h.push('.'),
                h.push(
                  typeof u.property == 'string' ? u.property : ke(u.property)
                ),
                ye(h, n.Member, c)
              );
            },
            ...
            YieldExpression: function (u, c, a) {
              ...
              return (
                ...
                u.argument &&
                  (h = Y(h, this.generateExpression(u.argument, n.Yield, S))),
                ye(h, n.Yield, c)
              );
            },
            ...
            UpdateExpression: function (u, c, a) {
              return u.prefix
                ? ye(
                    [
                      u.operator,
                      this.generateExpression(u.argument, n.Unary, S),
                    ],
                    n.Unary,
                    c
                  )
                : ye(
                    [
                      this.generateExpression(u.argument, n.Postfix, S),
                      u.operator,
                    ],
                    n.Postfix,
                    c
                  ...
                  ge(function (O) {
                    ...
                    for (V = 0, ae = u.elements.length; V < ae; ++V)
                      u.elements[V]
                        ? (A.push(w ? O : ''),
                          A.push(
                            P.generateExpression(u.elements[V], n.Assignment, S)
                          ))
            ...
            ClassExpression: function (u, c, a) {
              ...
              return (
                (h = ['class']),
                u.id &&
                  (h = Y(h, this.generateExpression(u.id, n.Sequence, S))),
                u.superClass &&
                  ((A = Y(
                    'extends',
                    this.generateExpression(u.superClass, n.Unary, S)
            ...
            MethodDefinition: function (u, c, a) {
              ...
              return (
                ...
                u.kind === 'get' || u.kind === 'set'
                  ? (A = [
                      Y(u.kind, this.generatePropertyKey(u.key, u.computed)),
                ...
                ? ((h = u.properties.length > 1),
                  ...
                  !h && !N(fe(w).toString())
                    ...
                    : (ge(function (O) {
                        ...
                        if (((A = ['{', m, O, w]), h))
                          for (
                            A.push(',' + m), V = 1, ae = u.properties.length;
                            V < ae;
                            ++V
                          )
                            A.push(O),
              ...
              return (
                ...
                ge(function (ae) {
                  ...
                  for (xe = 0, He = u.properties.length; xe < He; ++xe)
                    h.push(P ? ae : ''),
                      h.push(
                        V.generateExpression(u.properties[xe], n.Sequence, S)
                      ),
            ...
            ImportSpecifier: function (u, c, a) {
              var h = u.imported,
                ...
                w = u.local;
              return (
                w && w.name !== h.name && A.push(Be() + 'as' + Be() + ke(w)), A
              );
            },
              ...
              if (u.hasOwnProperty('raw') && x && _.raw)
                try {
                  if (
                    ...
                    h.type === t.Literal && h.value === u.value)
                  )
                    return u.raw;
                } catch {}
              return u.regex
            ...
            ComprehensionExpression: function (u, c, a) {
              ...
              return (
                ...
                _.moz.comprehensionExpressionStartsWithAssignment &&
                  ((P = this.generateExpression(u.body, n.Assignment, S)),
                  h.push(P)),
                u.blocks &&
                  ge(function () {
              ...
              return (
                u.left.type === t.VariableDeclaration
                  ? (h = [
                      u.left.kind,
                      Be(),
                      this.generateStatement(u.left.declarations[0], Q),
                    ])
            ...
            SpreadElement: function (u, c, a) {
              return [
                '...',
                this.generateExpression(u.argument, n.Assignment, S),
              ];
            },
              ...
              for (h = ['`'], A = 0, w = u.quasis.length; A < w; ++A)
                h.push(this.generateExpression(u.quasis[A], n.Primary, S)),
                  A + 1 < w &&
                    (h.push('${' + g),
                    h.push(
                      this.generateExpression(u.expressions[A], n.Sequence, S)
                    ),
                    h.push(g + '}'));
              return h.push('`'), h;
            },
            ...
            ImportExpression: function (u, c, a) {
              return ye(
                [
                  'import(',
                  this.generateExpression(u.source, n.Assignment, S),
                  ')',
                ],
                n.Call,
                c
          ...
          return (
            ...
            F
              ? ((A = h.toStringWithSourceMap({
                ...
                c.sourceContent &&
                  A.map.setSourceContent(c.sourceMap, c.sourceContent),
...
`,
        ...
        (K.parseFunction = function (e, t, n, r) {
          this.initFunction(e),
            ...
            t & at &&
              ((e.id =
                t & an && this.type !== f.name ? null : this.parseIdent()),
              e.id &&
                !(t & Vt) &&
                this.checkLVal(
                  e.id,
        ...
        (K.parseExport = function (e, t) {
          ...
          if (this.eat(f._default)) {
            ...
            if (this.type === f._function || (n = this.isAsyncFunction())) {
              ...
              this.next(),
                n && this.next(),
                (e.declaration = this.parseFunction(r, at | an, !1, n));
        ...
        (Ve.parseBindingList = function (e, t, n) {
          for (var r = [], i = !0; !this.eat(e); )
            if (
              (i ? (i = !1) : this.expect(f.comma), t && this.type === f.comma)
            )
              r.push(null);
            else {
        ...
        (re.checkPropClash = function (e, t, n) {
          if (
            ...
            if (s) {
              var l;
              o === 'init'
                ? (l = (this.strict && s.init) || s.get || s.set)
                : (l = s.init || s[o]),
        ...
        (re.parseParenAndDistinguishExpression = function (e) {
          ...
          if (this.options.preserveParens) {
            var T = this.startNodeAt(t, n);
            return (
              (T.expression = r), this.finishNode(T, 'ParenthesizedExpression')
            );
          } else return r;
        }),
...
`
        ...
        (re.parseProperty = function (e, t) {
          ...
          return (
            ...
            this.isAsyncProp(n)
              ? ((i = !0),
                (r = this.options.ecmaVersion >= 9 && this.eat(f.star)),
        ...
        (re.parseFunctionBody = function (e, t, n) {
          ...
          if (r)
            ...
            (this.labels = []),
              ...
              this.checkParams(
                e,
                !i && !o && !t && !n && this.isSimpleParamList(e.params)
              ),
        ...
        (qe = function (e) {
          (this.parser = e),
            ...
            (this.unicodeProperties =
              yn[e.options.ecmaVersion >= 11 ? 11 : e.options.ecmaVersion]),
            (this.source = ''),
            (this.flags = ''),
            (this.start = 0),
            (this.switchU = !1),
        ...
        ($.regexp_eatPatternCharacters = function (e) {
          for (var t = e.pos, n = 0; (n = e.current()) !== -1 && !Xn(n); )
            e.advance();
          return e.pos !== t;
        }),
        ...
        ($.regexp_eatUnicodePropertyValueExpression = function (e) {
          ...
          if (this.regexp_eatUnicodePropertyName(e) && e.eat(61)) {
            ...
            if (this.regexp_eatUnicodePropertyValue(e)) {
              ...
              return (
                this.regexp_validateUnicodePropertyNameAndValue(e, n, r), !0
              );
            }
          }
        ...
        ($.regexp_eatClassAtom = function (e) {
          ...
          if (e.eat(92)) {
            ...
            if (e.switchU) {
              var n = e.current();
              (n === 99 || Kn(n)) && e.raise('Invalid class escape'),
                e.raise('Invalid escape');
            }
            e.pos = t;
          }
        ...
        ($.regexp_eatHexDigits = function (e) {
          ...
          for (e.lastIntValue = 0; Hn((n = e.current())); )
            (e.lastIntValue = 16 * e.lastIntValue + Qn(n)), e.advance();
          return e.pos !== t;
        }),
        ...
        (ue.readRegexp = function () {
          for (var e, t, n = this.pos; ; ) {
            ...
            if (
              (Te.test(r) && this.raise(n, 'Unterminated regular expression'),
              e)
            )
              e = !1;
            else {
            ...
            for (; this.pos < this.input.length && B++ < 10; ) {
              if (((I = this.input[this.pos++]), I === ';')) {
                F[0] === '#'
                  ? F[1] === 'x'
                    ? ((F = F.substr(2)),
                      r.test(F) && (b = String.fromCharCode(parseInt(F, 16))))
                    : ((F = F.substr(1)),
                      i.test(F) && (b = String.fromCharCode(parseInt(F, 10))))
                  : (b = n[F]);
                break;
              }
              F += I;
        ...
        n =
          ...
          function () {
            ...
            for (var y = Array(p), C = 0, d = 0; d < D; d++)
              for (var E = arguments[d], m = 0, g = E.length; m < g; m++, C++)
                y[C] = E[m];
            return y;
          };
            ...
            p
              .map(function (k, v) {
                var R = p.length - 1 === v ? E.newLine : ',' + E.newLineOrSpace,
                  _ = l(k, C, D + C.indent);
                return (
                  C.transform && (_ = C.transform(p, v, _)), E.indent + _ + R
                );
              })
              .join('') +
            E.pad +
...
function Li(e) {
  ...
  if (Object.prototype.toString.call(e) !== '[object Object]') {
    ...
    return r == null ||
      !(
        (n = Object.getOwnPropertyDescriptor(e, Symbol.toStringTag)) != null &&
        n.writable
      )
      ? !1
      : e.toString() === `[object ${r}]`;
              ...
              : Yn(s.type, 'displayName')
                ...
                : (l = s.type.render) != null && l.displayName
                  ...
                  : typeof s.type == 'symbol' ||
                      (s.type.$$typeof && typeof s.type.$$typeof == 'symbol')
                    ? ea(s.type)
...
`
  ...
  au = (e, t) => {
    ...
    bu(() => {
      if (!r) {
        ...
        n.emit(gu, { id: C, source: i, args: E });
      }
    });
    let o = e();
    if (r) return o;
  ...
  la = {
    docs: {
      story: { inline: !0 },
      extractArgTypes: Ks,
      extractComponentDescription: yu,
    },
  },
  ca = [au],
  ha = [Fu];
