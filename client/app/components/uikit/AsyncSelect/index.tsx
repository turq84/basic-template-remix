import { type CSSProperties, forwardRef, useContext, useState } from 'react';
      ...
      <DialogTrigger>
        <div className={inputWrapperStyles}>
          ...
          <Popover
            ...
            style={
              {
                '--trigger-width': `${dimensions.width}px`,
              } as CSSProperties
            }
            offset={4}
          >
...
function AsyncSelectOptions({
  ...
  const { errorMessage = t('errorMessage'), emptyMessage = t('noOptions') } =
    props;
...
const AsyncSelectOptionsList = ({
  ...
  const handleSelect = (value: CommonProps['selected']) => {
    ...
    <>
      <ListBox<AsyncSelectOption>
        ...
        onSelectionChange={(selection) =>
          handleSelect(selection as Set<string>)
        }
